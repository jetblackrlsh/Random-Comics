...
## Key Item: Rechargeable Holo Shield

- First appears: Issue #1, "The Demon at the Door"
- Visual identifiers: translucent cyan-green hardlight shield, usually forearm-sized to full torso-sized, curved with a faint hex-grid surface, bright rim, and pulsing battery-like segments that dim when overused. It looks like solid light projected from Superhero Mandroid's wrist hardware.
- Continuity notes: The shield is made of hardlight and can block, slice, or sever other hardlight constructs. It needs recharge time if drained, but Issue #1 shows it has enough charge to cut the Pixel Demon's tendril and body.
- Reference image: `../reference-images/rechargeable-holo-shield-key-item.png`
