...
- First appears: Issue #1, "The Demon at the Door"
- Role: supporting character, creator of Superhero Mandroid. His name is Dr. Elias Dawes, though earlier issues often refer to him simply as the inventor.
- Visual identifiers: older human man in his early 60s with light skin, gray swept-back hair, tired blue eyes, narrow face, trimmed gray beard, wire-frame glasses, and a practical dark lab coat over a blue shirt. He wears a key card on a lanyard when working near the lab.
- Continuity notes: He is away at a conference during Issue #1, but his identity is used by the Pixel Demon as a holographic disguise. He is one of the few people who knows the hidden lab exists. In Issue #10, he uses the Lyoko-Tron-Matrix protocol to project a digital form of his mind into Superhero Mandroid's mechanical consciousness during a hack.
- Reference image: `../reference-images/inventor-character.png`

## Character: Pixel Demon

- First appears: Issue #1, "The Demon at the Door"
- Role: antagonist, digital demon and technology infiltrator.
- Visual identifiers: humanoid demon made of glowing blue pixels, fractured hardlight plates, flickering square particles, jagged horn-like pixel clusters, blank cyan eyes, clawed hands, and hologram tendrils that emerge from its back. Its body can break apart into an intangible cloud of blue pixels before reforming.
- Continuity notes: Can mimic a person with a hologram disguise, form hardlight tendrils, interface with low-level technology, and become temporarily intangible by dispersing into pixels. Its hardlight body can still be cut by Superhero Mandroid's holo shield.
- Reference image: `../reference-images/pixel-demon-character.png`

## Character: Shutdown Sludge Creature

- First appears: Issue #2, "Monsters Beneath Our Streets"
- Role: antagonist, interdimensional portal creature.
- Visual identifiers: massive purple sludge monster with a glossy tar-like body, rippling gelatinous folds, wet violet-black highlights, bulbous pseudopods, faint alien eyes or glowing cores buried under the surface, and a trail of dead electronics and darkened screens wherever it flows. It leaks downward from portals and spreads across streets like a living toxic flood.
- Continuity notes: Any electronic device the creature touches immediately shuts down. Superhero Mandroid cannot safely punch or touch it directly because his android systems could also shut down. It feeds on or drains projected holo-shield energy.
- Reference image: `../reference-images/shutdown-sludge-creature-character.png`

## Character: Sewer Fatbergs

- First appears: Issue #2, "Monsters Beneath Our Streets"
- Role: environmental monster colony and unexpected city defenders.
...
## Character: Todd Phillips

- First appears: Issue #10, "The Puppet Signal"
- Role: antagonist, disgraced cybersecurity engineer and human hacker who blames machines for erasing his life's work.
- Visual identifiers: human man in his early 40s with light skin, tired gray-green eyes, short messy dark blond hair, patchy stubble, narrow face, stress lines around the eyes, rumpled navy hoodie under an old black blazer, faded jeans, worn sneakers, and a battered messenger bag full of cables. His posture is hunched from long nights at terminals, and his expressions move from wounded pride to cold obsession.
- Continuity notes: Once designed classified cybersecurity programs for national defense, but he was laid off after AI coding agents replaced his work. Unable to discuss his service or find a new role, he turns his hacking skills against Superhero Mandroid, trying to seize the android as a puppet for theft and revenge. By the end of Issue #10, Todd is on the run and still determined to make machines pay.
- Reference image: `../reference-images/todd-phillips-character.png`

## Character: Computer Virus Monsters

- First appears: Issue #10, "The Puppet Signal"
- Role: digital attack swarm generated by Todd Phillips's intrusion into Superhero Mandroid's mechanical mind.
