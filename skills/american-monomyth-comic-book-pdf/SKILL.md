...
4. Script the cover, 20 story pages, and back cover.
   ...
   - For each story page, include the American Monomyth step name, step function, panel layout, visual beats, readable caption or dialogue text, continuity notes, action clarity notes, color palette, glow effects, and emotional intent.
   ...
   - Prefer readable comic panels with short integrated captions or dialogue. Avoid dense text that image generation is unlikely to render legibly.
...
5. Generate images.
   ...
   - Repeat that all readable story text must be generated directly inside the page art and that blank text boxes are not acceptable.
...
7. Verify and finalize.
   ...
   - Confirm exact page count, 4:5 portrait pages, all 10 steps covered, page-turn hooks on pages 3, 5, 7, 9, 11, 13, 15, 17, 19, and 21, readable integrated text, no later text overlays, bright anime-inspired superhero style, and consistent recurring visuals.
